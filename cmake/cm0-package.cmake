...
set(APP_DEBIAN_REVISION "10" CACHE STRING "Debian package revision/vendor suffix")
...
if(TARGET bundled_rtlsdr)
    install(TARGETS bundled_rtlsdr
        LIBRARY DESTINATION "${CMAKE_INSTALL_LIBDIR}/${APP_NAME}"
    )
    install(FILES "${rtlsdr_source_SOURCE_DIR}/COPYING"
        DESTINATION "${CMAKE_INSTALL_DOCDIR}"
        RENAME "librtlsdr-GPL-2.0-or-later.txt"
    )
endif()
