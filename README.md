...
| `APP_NAME` | `cardputerzero-sdr` | Application name used by installed asset lookup. |
...
# ./build/linux-x86-64/Release/cardputerzero-sdr
```
...
```shell
./build/darwin-arm64/Debug/cardputerzero-sdr
# or launch release build
# ./build/darwin-arm64/Release/cardputerzero-sdr
```
...
./build/darwin-x86-64/Debug/cardputerzero-sdr
# or launch release build
# ./build/darwin-x86-64/Release/cardputerzero-sdr
```
...
.\build\msvc\Debug\cardputerzero-sdr.exe

# alternatively for release build
# cmake --build --preset win32-msvc-rel
# .\build\msvc\Release\cardputerzero-sdr.exe
```
...
.\build\mingw64\Debug\cardputerzero-sdr.exe

# alternatively for release build
# cmake --build --preset win32-mingw64-rel
#.\build\mingw64\Release\cardputerzero-sdr.exe
```
> [!NOTE]
...
```shell
sudo apt install --no-install-recommends ./Zero SDR_0.2.0_m5stack1_arm64.deb
```
...
```text
dist/Zero SDR_0.2.0_m5stack1_arm64.deb
```
...
| Path | Content |
| --- | --- |
| `/usr/bin/cardputerzero-sdr` | Application executable. |
| `/etc/template-app.conf` | System-default application settings, including the startup theme. |
| `/usr/share/cardputerzero-sdr/` | Runtime assets: fonts, images, audio. |
| `/usr/share/APPLaunch/applications/cardputerzero-sdr.desktop` | APPLaunch launcher entry. |
| `/usr/share/APPLaunch/share/images/cardputerzero-sdr*.png` | APPLaunch launcher icons/fallbacks. |
| `/usr/lib/systemd/system/cardputerzero-sdr.service` | Optional systemd service for embedded autostart. |
| `/usr/share/doc/cardputerzero-sdr/` | README and third-party asset license notes. |
