...
public:
    ...
    lv_subject_t* audio_status_subject();
    lv_subject_t* audio_warning_subject();
...
private:
    ...
    bool published_audio_active_{false};
    ...
    reactive::StringSubject<32> audio_status_subject_;
    reactive::StringSubject<32> audio_warning_subject_;
