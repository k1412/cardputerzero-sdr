...
public:
    ...
    static constexpr uint32_t kIntermediateDecimation = 4;
    static constexpr uint32_t kIntermediateSampleRateHz =
        kDemodSampleRateHz / kIntermediateDecimation;
    static constexpr uint32_t kAudioDecimation =
        kIntermediateSampleRateHz / kAudioSampleRateHz;
...
private:
    ...
    static constexpr size_t kAudioFilterTaps = 127;
    ...
    uint32_t intermediate_decimation_phase_{0};
    std::array<float, kAudioFilterTaps> audio_history_{};
    size_t audio_history_position_{0};
