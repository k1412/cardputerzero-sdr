...
- Debian revision 8 for the Store candidate so its BQ27220 selection and power-evidence changes have a unique, reproducible version
...
- P0 preflight v5/result v3 evidence with continuous board-battery capacity, voltage, current, and temperature validation for the USB-power release gate
