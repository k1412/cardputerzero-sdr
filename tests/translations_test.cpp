...
int main() {
    ...
    assert(std::strcmp(i18n::translate(i18n::Locale::SimplifiedChinese, i18n::Text::UsbAccess), "USB权限") == 0);
    assert(std::strcmp(i18n::translate(i18n::Locale::TraditionalChinese, i18n::Text::ReconnectUsb), "重新插拔USB") == 0);
